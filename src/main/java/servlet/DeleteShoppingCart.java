...
public class DeleteShoppingCart extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteShoppingCart</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DeleteShoppingCart at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
        ...
        if (id != null) {
            ...
            if (cart != null) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (shoppingCart.getFoodId() == idDelete) {
                        iterator.remove();  // Sử dụng iterator để loại bỏ một cách an toàn
                    }
                }
