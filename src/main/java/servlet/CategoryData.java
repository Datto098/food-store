...
public class CategoryData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CategoryData</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CategoryData at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Get all categories
        ArrayList<Category> categories = CategoryDao.getCategoriesLimit(recordsPerPage, page);
        ...
        if (search != null) {
            categories = CategoryDao.searchCategory(search, recordsPerPage, page);
            totalPage = Math.ceil((double) categories.size() / recordsPerPage);
        ...
        request.getRequestDispatcher("category-data.jsp").include(request, response);
    }
