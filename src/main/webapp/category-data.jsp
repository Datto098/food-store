...
<html>
    ...
    <body>
        ...
        <div class="form-add">
            ...
            <form action="./add-category" method="post">
                <div class="mb-3">
                    <label for="category-name-add" class="form-label">Category Name</label>
                    <input type="text" class="form-control" id="category-name-add" name="category-name">
                </div>
                <div class="mb-3">
                    <label for="parent-id-add" class="form-label">Parent Id</label>
                    <input type="number" class="form-control" id="parent-id-add" name="parent-id">
                </div>
                <div class="mb-3">
                    <label for="category-link-add" class="form-label">Link</label>
                    <input type="text" class="form-control" id="category-link-add" name="href-value">
                </div>
        ...
        <div class="form-edit">
            ...
            <form action="./edit-category" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="parent-id" name="parent-id">
                </div>
                <div class="mb-3">
                    <label for="category-link" class="form-label">Link</label>
                    <input type="text" class="form-control" id="category-link" name="href-value">
                </div>
        ...
        <div class="container">
            <h1 class="text-center mt-3 mb-3">Category Data</h1>
            ...
            <table class="table w-100">
                ...
                <tbody>
                    <c:forEach items="${categories}" var="value">
                        <tr>
                            <th scope="row">${value.getCategoryId()}</th>
                            <td>${value.getCategoryName()}</td>
                            <td>${value.getParentId()}</td>
                            <td>${value.getHrefValue()}</td>
                            <td>
                                <div class="d-flex align-items-center justify-content-center w-fit">
                                    <form action="./delete-category" method="post" class="me-2 form-delete-category">
                                        <input name="id" value="${value.getCategoryId()}" hidden/>
                                        <button class="btn btn-danger btn-delete-category" type="button">Delete</button>
                                    </form>
                                    <button class="btn btn-primary btn-edit-category" data-edit="${value.getCategoryId()}">Edit</button>
                                </div>
                            </td>                                    
                        </tr>
                    </c:forEach>
    ...
    <script type="text/javascript">
        ...
        const inputCategoryName = document.querySelector("#category-name");
        const inputLink = document.querySelector("#category-link");
        const inputParentId = document.querySelector("#parent-id");
        ...
        btnEditCategory.forEach((btn) => {
            btn.addEventListener("click", (event) => {
                ...
                fetchData("./get-category-by-id?id=" + idEdit, "GET").then(data => {
                    inputCategoryId.value = data.categoryId;
                    inputCategoryName.value = data.categoryName;
                    inputParentId.value = data.parentId;
                    inputLink.value = data.hrefValue;
                });
            });
        });
